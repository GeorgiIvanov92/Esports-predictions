...
namespace EsportStats.Models
{
    public class Team
    {
        ...
        public int HextechDrakesKilled { get; set; }
        public int HextechDrakesLost { get; set; }
        public int ChemtechDrakesKilled { get; set; }
        public int ChemtechDrakesLost { get; set; }
